    ...
    <div className="flex flex-col lg:flex-row  lg:w-full items-center lg:items-start lg:justify-between mb-72 lg:mb-56 relative">
			<div className="flex-1">
				<Image
					...
					loading="eager"
                    quality={100}
					className=" h-[300px] lg:h-[580px] w-auto block absolute -bottom-72 lg:-bottom-56 left-[50%] translate-x-[-50%] lg:translate-x-0 lg:left-0"
				/>
			</div>
			...
			<div className="flex-1">
				<Image
					...
					loading="eager"
                    quality={100}
					className="h-[420px] w-auto  absolute -bottom-72 lg:-bottom-56 right-0  hidden lg:block "
				/>
			</div>
		</div>
  )
