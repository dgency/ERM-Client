...
function FacebookRelatedQuiz() {
	return (
		<div>
			<Quizhero heading="Website Facebook Marketing Score" />
			<div className="bg-[#F9FCFF] flex justify-center lg:justify-between px-4 sm:px-0 overflow-x-hidden">
				<Image
					src="/resources/quiz_details/facebook_quiz/facebook_left.svg"
					alt=""
					height={100}
					width={100}
				...
				<div className="font-openSans text-center mt-14 md:mt-10 xl:mt-20 mb-14 xl:mb-20 px-2 max-w-md sm:min-w-[450px] md:min-w-[500px] 2xl:min-w-[700px]">
					...
					<p className="text-[18px] md:text-[22px] font-semibold py-3 lg:py-6">
				...
				<Image
					src="/resources/quiz_details/facebook_quiz/facebook_right.svg"
					alt=""
					height={100}
					width={100}
					className="opacity-40 hidden sm:block w-[250px] lg:w-[250px] xl:w-[350px] h-full"
...
export default FacebookRelatedQuiz;
