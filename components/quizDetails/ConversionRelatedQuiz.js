	...
	return (
		<div>
			...
			<div className="bg-[#F9FCFF] flex justify-center lg:justify-between px-4 sm:px-0 overflow-x-hidden">
				<Image
					src="/resources/quiz_details/conversion_quiz/conversion_left.svg"
					alt=""
					height={100}
					width={100}
					className="opacity-40 hidden sm:block w-[250px] lg:w-[250px] xl:w-[350px] h-full"
				/>
				<div className=" text-center font-openSans mt-14 md:mt-10 xl:mt-20 mb-14 xl:mb-20 px-2 max-w-md sm:min-w-[450px] md:min-w-[500px] 2xl:min-w-[700px]">
					<p className=" lg:text-lg text-[#FF492C] font-semibold pb-1">ESCAPE ROOM WEBSITE</p>
					<h3 className="text-2xl font-bold pb-1 lg:pb-3">SEO Quiz</h3>
					...
					<p className="text-[20px] text-2xl font-semibold pb-6">No email required to get your results</p>
					...
					{/* <div
						...
						className=" md:h-[40vh] lg:w-[700px] m-auto"
					></div> */}

					<Script src="https://form-assets.forms.gozen.io/cdn/scripts/embed.js"></Script>
				</div>
				<Image
					src="/resources/quiz_details/conversion_quiz/conversion_right.svg"
					alt=""
					height={100}
					width={100}
					className="opacity-40 hidden sm:block w-[250px] lg:w-[250px] xl:w-[350px] h-full"
